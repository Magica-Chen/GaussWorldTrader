#!/usr/bin/env python3
"""Example runner for the BTC volatility breakout strategy."""
...
from src.strategy.crypto import BTCVolatilityBreakoutStrategy
...
def main() -> int:
    ...
    provider = AlpacaDataProvider()
    strategy = BTCVolatilityBreakoutStrategy()
    portfolio = Portfolio()
